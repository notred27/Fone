...
const Login = () => {
    ...
    return (
        <div>
            ...
            <img src = {logoImg} alt = "logo" style = {{width:"22vmax", paddingTop:"5vmax", paddingBottom:"5vmax", marginLeft:"auto", marginRight:"auto", display:"block", animationName:"logo-sway", animationIterationCount:"infinite", animationDuration:"3s"}} />
    
            <div className='centered' style={{maxWidth:"90%",backgroundColor:"white", borderRadius:"50px", padding:"10px"}}>
                <h1 style = {{fontSize:"2em", margin:"10px", width:"100%", textAlign:"center", fontWeight:"bold"}}>Fake Conversations, <span style={{color:"rgb(0, 102, 255)"}}>Real Projects.</span></h1>
                <p style={{fontSize:"1.2em", margin:"10px", textAlign:"center"}}>
